export const timexData = {
  navViews: [
    ...
    { id: "memoir", label: "回忆录", note: "把事件编排成章节", to: "/memoir" },
  ],
  stages: [
    { id: "all", label: "全部阶段" },
  ...
  events: [
    {
      ...
      longText: "那时还不知道未来会在哪里，但我们已经开始用照片、语音和很碎的文字去给人生做留档。",
    ...
    },
    {
      ...
      longText: "很多照片当年只留下了笑，没有留下原因。重新整理时才意识到，回忆录不是为了美化过去。",
    ...
    },
    {
      ...
      longText: "那一晚留下的素材不多，但密度很高。每件物品都还没有被摆到习惯的位置。",
    ...
    },
    {
      ...
      longText: "从早上起雾到夜里回房间，整个过程几乎没有刻意停下来整理。",
    ...
    },
    {
      ...
      longText: "最有趣的不是素材多，而是它们之间开始出现互相解释的关系。",
    ...
    },
    {
      ...
      longText: "很多真正重要的记忆并不壮观。它们甚至没有好的构图，只是恰好被留了下来。",
    ...
    },
    {
      ...
      longText: "当碎片被摆在一起的时候，变化比记忆本身更清楚。",
    ...
    },
    {
      ...
      longText: "空间并不是背景。很多关于成长的细节，其实是被一个地方反复承载出来的。",
...
export function createApi(data = timexData) {
...
export function filterEvents(events, api, state) {
  ...
  return api
    ...
    .filter((event) => {
      ...
      const target = [
        ...
        api.getPlace(event.placeId)?.name || "",
      ]
        .join(" ")
        .toLowerCase();
