...
> 📘 本文档仓库已通过 VitePress 渲染成静态站点并自动发布。
> 在线阅读：<https://growdu.github.io/timex/>
> 本目录原始 Markdown 仍可作为开发参考。

# 时光机器文档

> 个人成长记录与人生回忆沉淀系统 — 面向开发者与运维的完整文档 — 面向开发者与运维的完整文档
...
- [对象存储 / OSS 集成](./upload.md) — MinIO / Aliyun OSS / AWS S3 切换指南
