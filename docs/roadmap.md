...
| **后端测试覆盖** | ✓ | **156 tests passing** / 80% 行 / 77.17% 语句 / 72.62% 分支；8/8 controllers 100%；4/4 CRUD services 100% |
| **前端测试覆盖** | 🚧 | apiAdapter / lines / lineMatchers 100%；12 hooks 100%；Pages 待补 |
